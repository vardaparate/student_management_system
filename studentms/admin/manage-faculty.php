...
$sql="SELECT tblfaculty.FacultyID,tblfaculty.ID as sid,tblfaculty.FacultyName,tblfaculty.FacultyEmail,tblfaculty.DateofAdmission,tblfaculty.Department from tblfaculty  LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-faculty-detail.php?editid=<?php echo htmlentities ($row->sid);?>"><i class="icon-eye"></i></a>
