...
{               ?>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="manage-class.php">Assign Faculty</a></li>
                  <li class="nav-item"> <a class="nav-link" href="Assign-Courses.php">Assign Courses</a></li>
                  <li class="nav-item"> <a class="nav-link" href="Assign-HOD.php">Assign HOD</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#auth-fa" aria-expanded="false" aria-controls="auth">
                <span class="menu-title">Faculty</span>
                <i class="icon-doc menu-icon"></i>
              </a>
              <div class="collapse" id="auth-fa">
                <ul class="nav flex-column sub-menu">
