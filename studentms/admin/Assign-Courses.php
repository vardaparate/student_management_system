                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Assign Courses</th>
...
$sql="SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.ID,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.DateofAdmission,tblstudent.StudentClass from tblstudent  where tblstudent.StuID like '$sdata%' LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="Add-Student-Courses.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="icon-eye"></i></a>
                                                </div>
                            </td> 
                          </tr><?php 
$cnt=$cnt+1;
