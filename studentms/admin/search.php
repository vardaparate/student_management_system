...
$sql="SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.DateofAdmission,tblstudent.StudentClass from tblstudent  where tblstudent.StuID like '$sdata%' LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="add-Student-Courses.php?editid=<?php echo htmlentities ($row->sid);?>"><i class="icon-eye"></i></a>
