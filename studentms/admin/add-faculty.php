...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $ret="select UserName from tblfaculty where UserName=:uname || FacultyID=:stuid";
...
if($query -> rowCount() == 0)
{
$sql="insert into tblfaculty(FacultyName,FacultyEmail,Gender,Department,DOB,FacultyID,ContactNumber,UserName,Password)values(:stuname,:stuemail,:gender,:stuclass,:dob,:stuid,:connum,:uname,:password)";
...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Add Faculty</title>
    <!-- plugins:css -->
