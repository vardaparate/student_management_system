...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $connum=$_POST['connum'];
 $eid=$_GET['editid'];
$sql="update tblfaculty set FacultyName=:stuname,FacultyEmail=:stuemail,Gender=:gender,DOB=:dob,FacultyID=:stuid,ContactNumber=:connum where ID=:eid";
...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Update Faculty</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      <?php
$eid=$_GET['editid'];
$sql="SELECT tblfaculty.FacultyName,tblfaculty.FacultyEmail,tblfaculty.Department,tblfaculty.Gender,tblfaculty.DOB,tblfaculty.FacultyID,tblfaculty.ContactNumber,tblfaculty.UserName,tblfaculty.Password,tblfaculty.DateofAdmission from tblfaculty  where tblfaculty.ID=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                      <div class="form-group">
                        ...
                        <input type="text" name="stuname" value="<?php  echo htmlentities($row->FacultyName);?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Faculty Email</label>
                        <input type="text" name="stuemail" value="<?php  echo htmlentities($row->FacultyEmail);?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="stuid" value="<?php  echo htmlentities($row->FacultyID);?>" class="form-control" readonly='true'>
                      </div>
